...
use gstd::msg;
use sails_rs::{collections::HashSet, gstd::{service, event}, ActorId, Encode, Decode, TypeInfo, U256, String};
mod funcs;
use crate::services;
...
// a) El que EXIGE el macro: From (de sails_rs) de tu servicio extendido al base.
impl ::sails_rs::From<ExtendedService> for ::vft_service::Service {
    fn from(value: ExtendedService) -> Self {
        value.vft
    }
}

// b) (Opcional pero útil) AsRef (de sails_rs) para poder prestar el base sin moverlo.
impl ::sails_rs::AsRef<::vft_service::Service> for ExtendedService {
    fn as_ref(&self) -> &::vft_service::Service {
        &self.vft
    }
}
